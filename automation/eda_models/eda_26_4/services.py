...
class RoutedInterfaceIpv6Addresses(_EDABase):
    ip_prefix: str = Field(..., alias="ipPrefix", description="IP Address and prefix length in CIDR notation.", title="IP Prefix")
    primary: bool | None = Field(None, description="Indicates which address to use as primary.", title="Primary")
...
class RoutedInterfacePrefixes(_EDABase):
    ...
    preferred_lifetime_seconds: int | None = Field(604800, alias="preferredLifetimeSeconds", description="The length of time in seconds (relative to the time the packet is sent) that addresses generated from the prefix via ...", title="Preferred Lifetime", ge=0, le=4294967295)
    prefix: str = Field(..., description="An IPv6 global unicast address prefix.", title="IPv6 Prefix")
    valid_lifetime_seconds: int | None = Field(2592000, alias="validLifetimeSeconds", description="The length of time in seconds (relative to the time the packet is sent) that the prefix is valid for the purpose of o...", title="Valid Lifetime", ge=0, le=4294967295)


class RoutedInterfaceRouterAdvertisement(_EDABase):
    ...
    max_advertisement_interval_seconds: int = Field(..., alias="maxAdvertisementIntervalSeconds", description="Maximum time between router advertisements (in seconds).", title="Maximum Advertisement Interval", ge=4, le=1800)
    min_advertisement_interval_seconds: int = Field(..., alias="minAdvertisementIntervalSeconds", description="Minimum time between router advertisements (in seconds).", title="Minimum Advertisement Interval", ge=3, le=1350)
    ...
    reachable_time_ms: int | None = Field(0, alias="reachableTimeMs", description="Time in milliseconds for Neighbor Unreachability Detection.", title="Reachable Time", ge=0, le=3600000)
    retransmit_time_ms: int = Field(..., alias="retransmitTimeMs", description="Time in milliseconds between retransmitted NS messages.", title="Retransmit Time", ge=0, le=1800000)
    router_lifetime_seconds: int = Field(..., alias="routerLifetimeSeconds", description="Router lifetime in seconds for default gateway.", title="Router Lifetime", ge=0, le=9000)


class RoutedInterfaceIpv6SpecificParameters(_EDABase):
    learn_unsolicited_na: Literal['All', 'Global', 'LinkLocal', 'Disabled'] | None = Field('Disabled', alias="learnUnsolicitedNA", description="Enable or disable learning of unsolicited Neighbor Advertisements.", title="Unsolicited NA Learning")
    router_advertisement: RoutedInterfaceRouterAdvertisement | None = Field(None, alias="routerAdvertisement", description="Manages IPv6 Router Advertisement parameters.", title="Router Advertisement")
...
class RoutedInterfaceIpv4SpecificParameters(_EDABase):
    arp_timeout_seconds: int | None = Field(14400, alias="arpTimeoutSeconds", description="Duration of time that dynamic ARP entries remain in the ARP cache before they expire.", title="ARP Timeout", ge=0)
    ...
    learn_unsolicited_arp: Literal['Enabled', 'Disabled'] | None = Field('Disabled', alias="learnUnsolicitedARP", description="Enable or disable learning of unsolicited ARPs.", title="Learn Unsolicited ARPs")
...
class RoutedInterfaceIngressActions(_EDABase):
    ...
    qos_policies: list[str] | None = Field(None, alias="qosPolicies", description="List of QoS Ingress policy references to use at ingress.", title="QoS Ingress Policy")
...
class RoutedInterfaceEgressActions(_EDABase):
    ...
    qos_policies: list[str] | None = Field(None, alias="qosPolicies", description="List of QoS Egress policy references to use at egress.", title="QoS Egress Policy")


class RoutedInterfaceBfdConfiguration(_EDABase):
    desired_min_transmit_int_ms: int | None = Field(1000, alias="desiredMinTransmitIntMs", description="The minimum interval in milliseconds between transmission of BFD control packets.", title="Transmit Interval", ge=10, le=100000)
    ...
    required_min_echo_receive_int_ms: int | None = Field(0, alias="requiredMinEchoReceiveIntMs", description="The minimum interval between echo packets the local node can receive.", title="Minimum Echo Receive Interval", ge=0, le=100000)
    required_min_receive_int_ms: int | None = Field(1000, alias="requiredMinReceiveIntMs", description="The minimum interval in milliseconds between received BFD control packets that this system should support.", title="Receive Interval", ge=10, le=100000)
...
class RoutedInterfaceSpec(_EDABase):
    ...
    ipv4: RoutedInterfaceIpv4SpecificParameters | None = Field(None, description="IPv4 parameters that are not applicable to IPv6.", title="IPv4-specific Parameters")
    ...
    ipv6: RoutedInterfaceIpv6SpecificParameters | None = Field(None, description="IPv6 parameters that are not applicable to IPv4.", title="IPv6-specific Parameters")
...
class VLANUplink(_EDABase):
    ...
    uplink_selectors: list[str] | None = Field(None, alias="uplinkSelectors", description="Selects TopoLinks which connect a leaf switch to a breakout switch. This is the uplink between your access breakout s...", title="Uplink Selector")
...
class VLANSpec(_EDABase):
    ...
    interface_selectors: list[str] = Field(..., alias="interfaceSelectors", description="Interfaces to use for attachment to this VLAN based on the label selector.  Selects Interfaces based on their associa...", title="Interface Selector")
    ...
    mac_duplication_detection_action: Literal['Blackhole', 'OperDown', 'StopLearning', 'BridgeDomainAction'] | None = Field(None, alias="macDuplicationDetectionAction", description="If Mac Duplication Detection is enabled on the associated Bridge Domain, this property will override the MDD action s...", title="MAC Duplication Detection Action")
...
class IRBInterfaceVirtualIpDiscovery(_EDABase):
    ...
    allowed_ma_cs: list[str] | None = Field(None, alias="allowedMACs", description="List of allowed MAC addresses for a discovered virtual IP address.", title="Allowed MAC Addresses")
    bridge_interfaces: list[str] | None = Field(None, alias="bridgeInterfaces", description="List of BridgeInterfaces on the associated MAC-VRF to which the ARP probes are sent. If left blank, the probes are se...", title="Bridge Interfaces to Probe")
    probe_interval_seconds: int | None = Field(0, alias="probeIntervalSeconds", description="ARP probe interval in seconds.", title="Probe Interval", ge=0, le=86400)
    vlans: list[str] | None = Field(None, description="List of VLANs on the associated BridgeDomain to which the ARP probes are sent.  If left blank, the probes are sent on...", title="VLANs to Probe")
...
class IRBInterfaceRouterAdvertisement(_EDABase):
    current_hop_limit: int = Field(..., alias="currentHopLimit", description="The current hop limit to advertise in the router advertisement messages.", title="Current Hop Limit", ge=0, le=255)
    enabled: bool = Field(..., description="Enable or disable IPv6 router advertisements.", title="Enable Router Advertisements")
    ip_mtu: int | None = Field(None, alias="ipMTU", description="The IP MTU to advertise in the router advertisement messages.", title="IP MTU", ge=1280, le=9486)
    managed_configuration_flag: bool = Field(..., alias="managedConfigurationFlag", description="Enable DHCPv6 for address configuration (M-bit).", title="Managed Configuration Flag")
...
class IRBInterfaceIpv6SpecificParameters(_EDABase):
    learn_unsolicited_na: Literal['All', 'Global', 'LinkLocal', 'Disabled'] | None = Field('Disabled', alias="learnUnsolicitedNA", description="Enable or disable learning of unsolicited Neighbor Advertisements.", title="Unsolicited NA Learning")
    router_advertisement: IRBInterfaceRouterAdvertisement | None = Field(None, alias="routerAdvertisement", description="Manages IPv6 Router Advertisement parameters.", title="Router Advertisement")
...
class IRBInterfaceIpv6Addresses(_EDABase):
    anycast: bool | None = Field(None, description="Indicates if the address is an anycast IRB address.", title="Anycast")
    ip_prefix: str = Field(..., alias="ipPrefix", description="IP Address and prefix length in CIDR notation.", title="IP Prefix")
    primary: bool | None = Field(None, description="Indicates which address to use as primary.", title="Primary")
...
class IRBInterfaceStatic(_EDABase):
    datapath_programming: bool | None = Field(None, alias="datapathProgramming", description="Enable datapath programming for host routes.", title="Datapath Programming")
    populate: bool = Field(..., description="Enable population of host routes based on ARP/ND entries.", title="Populate")


class IRBInterfaceEvpnLearned(_EDABase):
    datapath_programming: bool | None = Field(None, alias="datapathProgramming", description="Enable datapath programming for host routes.", title="Datapath Programming")
    populate: bool = Field(..., description="Enable population of host routes based on ARP/ND entries.", title="Populate")


class IRBInterfaceDynamic(_EDABase):
    datapath_programming: bool | None = Field(None, alias="datapathProgramming", description="Enable datapath programming for host routes.", title="Datapath Programming")
    populate: bool = Field(..., description="Enable population of host routes based on ARP/ND entries.", title="Populate")


class IRBInterfaceHostRoutePopulation(_EDABase):
    dynamic: IRBInterfaceDynamic | None = Field(None, description="Create host routes out of dynamic ARP/ND entries.", title="Dynamic")
    evpn: IRBInterfaceEvpnLearned | None = Field(None, description="Create host routes out of EVPN learned ARP/ND entries.", title="EVPN Learned")
    static: IRBInterfaceStatic | None = Field(None, description="Create host routes out of static ARP/ND entries.", title="Static")
...
class IRBInterfaceSpec(_EDABase):
    ...
    ip_addresses: list[IRBInterfaceIpAddresses] | None = Field(None, alias="ipAddresses", description="Configures IP addresses on the IRBInterface.", title="IP Addresses")
    ip_mtu: int | None = Field(1500, alias="ipMTU", description="IP MTU for the IRBInterface [default=1500].", title="IP MTU", ge=1280, le=9486)
    ipv4: IRBInterfaceIpv4SpecificParameters | None = Field(None, description="IPv4 parameters that are not applicable to IPv6.", title="IPv4-specific Parameters")
    ipv6: IRBInterfaceIpv6SpecificParameters | None = Field(None, description="IPv6 parameters that are not applicable to IPv4.", title="IPv6-specific Parameters")
...
class RouterResilientHashing(_EDABase):
    prefixes: list[RouterPrefix] | None = Field(None, description="IPv4 or IPv6 prefix. Active routes in the FIB that exactly match this prefix or that are longer matches of this prefi...", title="Prefix")


class RouterVxlanOptions(_EDABase):
    ...
    vni: int | None = Field(None, description="VNI for the Router; leave blank for auto-allocation from VNI pool. Only applicable to VXLAN encapsulation.", title="VNI", ge=1, le=16777215)
    vni_pool: str | None = Field('vni-pool', alias="vniPool", description="Reference to VNI pool for auto-allocation. Only applicable to VXLAN encapsulation.", title="VNI Allocation Pool")


class RouterMplsOptions(_EDABase):
    allowed_tunnel_types: list[str] | None = Field(None, alias="allowedTunnelTypes", description="Allowed tunnel types for MPLS transport.", title="Allowed Tunnel Types")


class RouterEncapsulationOptions(_EDABase):
    mpls: RouterMplsOptions | None = Field(None, description="MPLS encapsulation optionss. Only applicable if MPLS encapsulation is used (Type=EVPNMPLS or Type=IPVPN).", title="MPLS Options")
    vxlan: RouterVxlanOptions | None = Field(None, description="VXLAN encapsulation options. Only applicable if VXLAN encapsulation is used (Type=EVPNVXLAN).", title="VXLAN Options")
...
class RouterIpv4Unicast(_EDABase):
    advertise_i_pv6_next_hops: bool | None = Field(None, alias="advertiseIPv6NextHops", description="Enables advertisement of IPv4 Unicast routes with IPv6 next-hops to peers.", title="Advertise IPv6 Next Hops")
    enabled: bool = Field(..., description="Enables the IPv4 unicast AFISAFI.", title="Enabled")
    multipath: RouterMultipath | None = Field(None, description="Enable multipath.", title="Multipath")
    receive_i_pv6_next_hops: bool | None = Field(None, alias="receiveIPv6NextHops", description="Enables the advertisement of the RFC 5549 capability to receive IPv4 routes with IPv6 next-hops.", title="Receive IPv6 Next Hops")
...
class RouterBgpConfiguration(_EDABase):
    ...
    export_policies: list[str] | None = Field(None, alias="exportPolicies", description="Reference to a Policy CR that will be used to filter routes advertised to peers.", title="Export Policy")
    ...
    import_policies: list[str] | None = Field(None, alias="importPolicies", description="Reference to a Policy CR that will be used to filter routes received from peers.", title="Import Policy")
    ...
    min_wait_to_advertise_seconds: int | None = Field(0, alias="minWaitToAdvertiseSeconds", description="Minimum wait time before advertising routes post BGP restart.", title="Min Wait To Advertise Time", ge=0, le=3600)
...
class RouterSpec(_EDABase):
    ...
    encap_options: RouterEncapsulationOptions | None = Field({'vxlan': {'tunnelIndexPool': 'tunnel-index-pool', 'vniPool': 'vni-pool'}}, alias="encapOptions", description="Encapsulation-specific options (such as MPLS tunneling options).", title="Encapsulation Options")
    evi: int | None = Field(None, description="EVI for the Router; leave blank for auto-allocation from EVI pool. Optional for IPVPN (can be used to auto-derive RTs...", title="EVI", ge=1, le=65535)
    ...
    node_selectors: list[str] | None = Field(None, alias="nodeSelectors", description="Node selectors for deployment constraints.  If Nodes are selected, the Router will only be deployed on the Nodes sele...", title="Node Selector")
    resilient_hashing: RouterResilientHashing | None = Field(None, alias="resilientHashing", description="Resilient Hashing configuration.", title="Resilient Hashing")
    ...
    type: Literal['Simple', 'EVPNVXLAN', 'EVPNMPLS', 'IPVPN'] | None = Field('EVPNVXLAN', description="Select the type of Router. Simple doesn't include any overlay control plane or dataplane properties (such as EVPN/VXL...", title="Type")


class BridgeDomainMacLearning(_EDABase):
    aging_time_seconds: int | None = Field(300, alias="agingTimeSeconds", description="Configurable aging time for dynamically learned mac addresses.", title="MAC Aging", ge=60, le=86400)
    enabled: bool = Field(..., description="Enables or disables MAC learning for the BridgeDomain.", title="Enabled")
...
class BridgeDomainMacDuplicationDetection(_EDABase):
    ...
    hold_down_time_minutes: int | None = Field(9, alias="holdDownTimeMinutes", description="Time to wait in minutes from the moment a mac is declared duplicate to the mac is flushed from the bridge table.", title="Hold Down Time", ge=2, le=60)
    monitoring_window_minutes: int | None = Field(3, alias="monitoringWindowMinutes", description="Monitoring window in minutes for detecting duplication on a given mac address.", title="Monitoring Window", ge=1, le=15)
...
class BridgeDomainL2ProxyArpNdIpDuplicationDetection(_EDABase):
    ...
    hold_down_time_minutes: int | None = Field(9, alias="holdDownTimeMinutes", description="Time to wait in minutes from the moment an IP is declared duplicate to the time the IP is removed from the proxy ARP/...", title="Hold Down Time", ge=2, le=60)
    monitoring_window_minutes: int | None = Field(3, alias="monitoringWindowMinutes", description="Monitoring window for detecting duplication on a given IP address in the proxy ARP/ND table.", title="Monitoring Window", ge=1, le=15)
...
class BridgeDomainDynamicLearning(_EDABase):
    aging_time_seconds: int | None = Field(None, alias="agingTimeSeconds", description="Aging timer value for the proxy entries in seconds. If not set, this indicates that the entries are never flushed.", title="Age Time", ge=60, le=86400)
    enabled: bool | None = Field(False, description="Enables or disables Dynamic Learning.", title="Enabled")
    refresh_interval_seconds: int | None = Field(None, alias="refreshIntervalSeconds", description="The interval determines the frequency at which the system generates three ARP Requests or Neighbor Solicitations with...", title="Send Refresh Interval", ge=120, le=86400)


class BridgeDomainL2ProxyArpNd(_EDABase):
    dynamic_learning: BridgeDomainDynamicLearning | None = Field(None, alias="dynamicLearning", description="Configures dynamic learning of ARP/ND entries in the proxy table.", title="Dynamic Learning")
    ip_duplication: BridgeDomainL2ProxyArpNdIpDuplicationDetection | None = Field(None, alias="ipDuplication", description="Configures IP duplication detection and resolution mechanisms.", title="L2 Proxy ARP/ND IP Duplication Detection")
    max_entries: int | None = Field(250, alias="maxEntries", description="Maximum number of entries allowed in the proxy table of the bridge domain.", title="L2 Proxy ARP/ND Table Size", ge=1, le=8192)
...
class BridgeDomainVxlanOptions(_EDABase):
...
class BridgeDomainMplsOptions(_EDABase):
    allowed_tunnel_types: list[str] | None = Field(None, alias="allowedTunnelTypes", description="Allowed tunnel types for MPLS transport.", title="Allowed Tunnel Types")
    control_word: bool | None = Field(None, alias="controlWord", description="Enable or disable the use of control word. Applicable only to EVPNMPLS service Type.", title="Enable Control Word")


class BridgeDomainEncapsulationOptions(_EDABase):
    mpls: BridgeDomainMplsOptions | None = Field(None, description="MPLS encapsulation options. Only applicable if MPLS encapsulation is used (Type=EVPNMPLS).", title="MPLS Options")
    vxlan: BridgeDomainVxlanOptions | None = Field(None, description="VXLAN encapsulation options. Only applicable if VXLAN encapsulation is used (Type=EVPNVXLAN).", title="VXLAN Options")
...
class BridgeDomainSpec(_EDABase):
    ...
    encap_options: BridgeDomainEncapsulationOptions | None = Field({'vxlan': {'tunnelIndexPool': 'tunnel-index-pool', 'vniPool': 'vni-pool'}}, alias="encapOptions", description="Encapsulation-specific options (such as MPLS tunneling options).", title="Encapsulation Options")
    ...
    mac_learning: BridgeDomainMacLearning | None = Field({'agingTimeSeconds': 300, 'enabled': True}, alias="macLearning", description="Enable MAC learning for this BridgeDomain.", title="MAC Learning")
    ...
    type: Literal['Simple', 'EVPNVXLAN', 'EVPNMPLS'] | None = Field('EVPNVXLAN', description="Select the type of BridgeDomain.  Simple doesn't include any overlay control plane or dataplane properties (EVPN/VXLA...", title="Type")
