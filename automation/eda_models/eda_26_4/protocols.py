...
class StaticRouteFollow(_EDABase):
    mode: Literal['NextLongest'] = Field(..., description="Follow mode. Only \"NextLongest\" is supported, which means that the route will follow the next-hop-group of the next...", title="Mode")
...
class StaticRouteNexthopGroup(_EDABase):
    ...
    follow: StaticRouteFollow | None = Field(None, description="Follow the resolution of another route. This setting is mutually exclusive with all other settings in the group.", title="Follow")
