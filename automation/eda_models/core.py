...
class NodeProfileSpec(_EDABase):
    ...
    operating_system: Literal['srl', 'sros', 'eos', 'sonic', 'ios-xr', 'nxos', 'linux'] = Field(..., alias="operatingSystem", description="Sets the operating system of this NodeProfile, e.g. srl.", title="Operating System")
...
class TopoNodeSpec(_EDABase):
    ...
    operating_system: Literal['srl', 'sros', 'eos', 'sonic', 'ios-xr', 'nxos', 'linux'] = Field(..., alias="operatingSystem", description="Operating system running on this TopoNode, e.g. srl.", title="Operating System")
    ...
    version: str = Field(..., description="Sets the software version of this TopoNode, e.g. 24.7.1 (for srl), or 24.7.r1 (for sros).", title="Version")
